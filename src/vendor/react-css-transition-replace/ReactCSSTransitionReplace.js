...
export default class ReactCSSTransitionReplace extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      currentKey: '1',
      currentChild: this.props.children ? this.props.children : undefined,
      prevChildren: {},
      height: null,
      width: null
    };
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    const nextChild = nextProps.children ? nextProps.children : undefined;
  ...
  performHeightTransition = () => {
    if (!this.unmounted) {
      ...
      this.setState({
        ...
        width: this.props.changeWidth ? (currentChildNode ? currentChildNode.offsetWidth : 0) : null
      });
    }
    this.rafHandle = null;
  };
